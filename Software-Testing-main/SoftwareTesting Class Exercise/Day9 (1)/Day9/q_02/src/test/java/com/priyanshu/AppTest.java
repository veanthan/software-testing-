...
import com.priyanshu.brave.BraveDriver;
...
public class AppTest {
    ...
    public void setupExcel() throws Exception {
        Workbook workbook = new XSSFWorkbook("./assets/sheets/ixigo-user-booking.xlsx");
    ...
    public void setupReport() {
        ExtentSparkReporter spark = new ExtentSparkReporter("./src/report/report.html");
